...
const Posits = (props: IconProps) => {
    ...
    return (
        ...
        >
            ...
            <path d="M512 448a64 64 0 1 0 0-128 64 64 0 0 0 0 128m0 64a128 128 0 1 1 0-256 128 128 0 0 1 0 256m345.6 192L960 960H672v-64H352v64H64l102.4-256zm-68.928 0H235.328l-76.8 192h706.944z"/>
        </svg>
    );
};

export default Posits;